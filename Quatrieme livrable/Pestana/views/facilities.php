...
?>
<section class="facilities-main d-flex align-items-center flex-column justify-content-center">
	...
	<div class="container">
		<div class="row">
			<div class="col-12 my-5 position-relative">
				...
				<p class="fs-2 fw-bold text-light position-absolute ms-auto me-auto text-center mb-0 text-black">
					GYM
				</p>
			</div>
			<div class="col-12 my-5 position-relative">
