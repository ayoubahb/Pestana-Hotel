				...
				<form class="needs-validation" novalidate method="post">
					<div class="row g-3">
						...
						<div class="col-6">
							...
							<input type="date" class="form-control" name="checkin" readonly value="<?php echo $_SESSION['data']['checkin'] ?>" />
						</div>

						<div class="col-6">
							<label class="form-label">ChekOut</label>
							<input type="date" class="form-control" name="checkout" readonly value="<?php echo $_SESSION['data']['checkout'] ?>" />
						</div>


						<div class="col-12">
							<label for="address2" class="form-label">N° of persons (max <?php echo $room["room_max"] ?> pesons)</label>
							<input type="number" class="form-control" name="num-person" id="num-person" min="0" max="<?php echo $room["room_max"]; ?>" />
						</div>
